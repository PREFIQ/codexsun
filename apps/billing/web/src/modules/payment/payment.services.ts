...
export const updatePayment = (id: string, input: PaymentInput) =>
  billingApiPut<Payment>(`/billing/payments/${id}`, input);
export const setPaymentStatus = (id: string, status: PaymentStatus) =>
  billingApiPost<Payment>(`/billing/payments/${id}/status`, { status });
