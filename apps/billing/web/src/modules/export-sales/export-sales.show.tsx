...
import { formatDate, formatDateTime, formatMoney, totalExportSaleQuantity } from "./export-sales.services";
import { ExportSalesPrintDocument } from "./export-sales.print";
import type { ExportSale } from "./export-sales.types";

export function ExportSalesShowPage({
  onBack,
  onEdit,
  onNew,
  onPrint,
  ...
  return (
    <WorkspacePage
      ...
      description="Review export sales details, totals, and the live print preview for this record."
      actions={
        ...
        <div className="space-y-4">
          <WorkspaceShowCard title="Totals">
            <WorkspaceDetailTable
              rows={[
                ...
                ["Quantity", totalExportSaleQuantity(sale)],
          ...
          <WorkspaceShowCard title="Notes">
            <div className="px-4 py-3 text-sm leading-6 text-muted-foreground whitespace-pre-wrap">
              {sale.notes || "No notes were added for this export sales record."}
            </div>
          </WorkspaceShowCard>
          ...
          <WorkspacePrintPreview label="Print Preview">
            <div className="origin-top scale-[0.42] sm:scale-[0.56] md:scale-[0.62] lg:scale-[0.48] xl:scale-[0.56]">
              <ExportSalesPrintDocument sale={sale} />
            </div>
