...
import { formatDate, formatDateTime, formatMoney, totalSaleQuantity } from "./sales.services";
import { SalesPrintDocument } from "./sales.print";
...
export function SalesShowPage({
  ...
  return (
    <WorkspacePage
      ...
      description="Review invoice details, totals, and the live print preview for this sales record."
      actions={
        ...
        <div className="space-y-4">
          <WorkspaceShowCard title="Totals">
            <WorkspaceDetailTable
              rows={[
                ...
                ["Quantity", totalSaleQuantity(sale)],
          ...
          <WorkspaceShowCard title="Notes">
            <div className="px-4 py-3 text-sm leading-6 text-muted-foreground whitespace-pre-wrap">
              {sale.notes || "No notes were added for this sales record."}
            </div>
          </WorkspaceShowCard>
