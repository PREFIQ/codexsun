...
function selectSaleItems(saleId: number) {
...
async function insertItems(transaction: SalesTransaction, saleId: number, items: SaleLineItem[]) {
...
async function upsertEway(transaction: SalesTransaction, saleId: number, value: SaleEwayDetails) {
...
async function existingIds(database: Kysely<SalesDatabase>, query: RawBuilder<unknown>) {
...
function toSaleItem(row: SaleItemRow): SaleLineItem {
  return {
...
function formatAddress(row: SaleHeaderRow, kind: "billing" | "shipping") {
