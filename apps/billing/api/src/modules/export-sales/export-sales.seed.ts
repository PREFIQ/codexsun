...
import { normalizeSaleInput } from "./export-sales.service.js";
import { ExportSalesRepository } from "./export-sales.repository.js";

export const salesSeed = {
  key: "billing.export-sales.seed",
  description: "Export sales module seeds default tenant rows into the configured database."
};

const defaultSales: ExportSaleSavePayload[] = [
  {
...
export async function seedSalesModule(database: Kysely<any>) {
  ...
  const repository = new ExportSalesRepository();
