...
import type { ProjectManagerKind, ProjectManagerRecord, ProjectManagerResult } from "./project-manager.types";
...
export function createProjectManagerRecord(kind: ProjectManagerKind, payload: Record<string, unknown>) {
  return apiPost<ProjectManagerRecord>(`/admin/project-manager/${kind}`, payload, "sa");
}

export function updateProjectManagerRecord(kind: ProjectManagerKind, id: string, payload: Record<string, unknown>) {
...
export function deleteProjectManagerRecord(kind: ProjectManagerKind, id: string) {
  return apiDelete<{ deleted: boolean; id: string; title: string }>(`/admin/project-manager/${kind}/${id}`, "sa");
}
