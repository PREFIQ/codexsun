export type CountryKind = "country" | "state" | "district" | "city" | "pincode";
...
export type CountryDefinition = {
  columns: Array<{ key: keyof CountryRecord; label: string }>;
  kind: CountryKind;
  label: string;
  path: string;
  plural: string;
...
export const countryDefinitions: Record<CountryKind, CountryDefinition> = {
  country: {
    columns: [
