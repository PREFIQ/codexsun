export type StateKind = "country" | "state" | "district" | "city" | "pincode";
...
export type StateSavePayload = Omit<StateRecord, "id">;

export type StateDefinition = {
  columns: Array<{ key: keyof StateRecord; label: string }>;
  kind: StateKind;
  label: string;
  path: string;
  plural: string;
...
export const stateDefinitions: Record<StateKind, StateDefinition> = {
  country: {
    columns: [
